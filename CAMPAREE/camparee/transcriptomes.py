...
def prep_transcriptomes(samples, data_directory, log_directory, kallisto_file_path, bowtie2_dir_path, output_type, output_molecule_count, dispatcher_mode="serial", seed=None):
    ...
    for sample in samples:
        ...
        command = f"python -m camparee.transcriptomes {sample.sample_id} {data_directory} {log_directory} {kallisto_file_path} {bowtie2_dir_path} {output_type} {output_molecule_count} --fastq_files {' '.join(sample.fastq_file_paths)} --seed {sample_seed}"
