...
if __name__ == '__main__':
    info = {
        "molecule_info": "original: 50K, Size 5k, 200 Tail normal distribution - from fragment log",
        "model_info": "2 ^ number of cycles",
        "param_info": "number of cycles - 8"
    }
    generate_graphs("../../data/pcr_amplification_step_input_data.log","../../data/pcr_amplification_step_output_data.log", info)
    app.run_server()